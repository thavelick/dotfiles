# PATH
export PATH=$PATH:$HOME/.local/bin:$HOME/.claude/local:$HOME/.lmstudio/bin:$HOME/dotfiles-bin:$HOME/go/bin:$HOME/.cargo/bin:$HOME/.npm-global/bin
...
setopt NO_BEEP               # Disable beeping on errors (tab completion, etc)
